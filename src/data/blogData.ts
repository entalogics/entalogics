...
export const blogData: { [key: string]: BlogPost } = {
  'ai-development-trends-2024': {
    ...
    title: 'Building <span style="background: linear-gradient(135deg, #3B82F6, #8B5CF6, #3B82F6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">AI Development Trends</span> That Will Dominate 2024',
  ...
  'saas-architecture-best-practices': {
    ...
    title: 'Building <span style="background: linear-gradient(135deg, #3B82F6, #8B5CF6, #3B82F6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Scalable SaaS Architecture</span>: Best Practices for 2024',
    ...
    image: '/assets/services/web-app.jpg'
  },
