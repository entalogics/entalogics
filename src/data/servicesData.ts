...
export const servicesData: Record<string, Service> = {
  ...
  "maintenance-support": {
    ...
    techStack: {
      ...
      infrastructure: [
        { name: "Amazon AWS", icon: "https://cdn.simpleicons.org/amazonaws" },
        { name: "Docker", icon: "https://cdn.simpleicons.org/docker" },
  ...
  "cloud-devops-solutions": {
    ...
    portfolio: [
      ...
      },
      {
        ...
        technologies: ["Azure", "GitHub Actions", "Kubernetes", "Monitoring"],
      },
    ],
  },
  "automation-workflow-tools": {
    ...
    techStack: {
      backend: [
        ...
        { name: "PowerShell", icon: "https://cdn.simpleicons.org/powershell" }
      ],
      tools: [
        { name: "Zapier", icon: "https://cdn.simpleicons.org/zapier" },
        { name: "Microsoft Power Automate", icon: "https://cdn.simpleicons.org/microsoftpowerautomate" },
        ...
        { name: "Microsoft Teams", icon: "https://cdn.simpleicons.org/microsoftteams" },
