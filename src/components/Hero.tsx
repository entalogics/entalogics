...
const Hero = () => {
  return (
    <>
      <section id="home" className="relative w-full bg-white dark:bg-[#0a1225] overflow-hidden flex flex-col items-center justify-center py-24 md:py-32 px-4 md:px-12 text-center">
