    ...
    <>
      ...
      >
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
          ...
          <Heading level={1}
            className={`relative text-[clamp(1.3rem,6vw,3.2rem)] font-extrabold leading-[1.15] mb-4 md:mb-6 lg:mb-7 tracking-tight ${poppins.className}`}
          >
            ...
            <span className="text-black dark:text-white"> Company Build with </span>
            <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-clip-text text-transparent">Logic</span>
          ...
          <div className="flex flex-col sm:flex-row md:flex-row lg:flex-row items-center justify-center gap-4 w-full sm:w-auto md:w-auto lg:w-auto mb-6">
            <a href="/contact" className="relative group">
              ...
              <div className="absolute -inset-[2px] bg-gradient-to-r from-cyan-400 via-blue-500 via-purple-500 to-cyan-400 rounded-lg opacity-75 group-hover:opacity-100 blur-sm transition-opacity duration-300 animate-[gradient-rotate_3s_linear_infinite] bg-[length:200%_200%]"></div>
              <div className="absolute -inset-[2px] bg-gradient-to-r from-cyan-400 via-blue-500 via-purple-500 to-cyan-400 rounded-lg animate-[gradient-rotate_3s_linear_infinite] bg-[length:200%_200%]"></div>
              
              {/* Button content */}
              <button className="relative bg-white dark:bg-gray-900 text-gray-900 dark:text-white font-semibold text-sm px-6 py-3 rounded-lg flex items-center gap-2 transition-all duration-300 hover:scale-[1.02] w-full sm:w-auto">
            ...
            <Link href="/about">
              <Button variant="secondary" size="sm" className="w-full sm:w-auto text-sm px-5 py-3">
                Why choose us
              </Button>
            </Link>
          </div>
