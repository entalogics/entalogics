    ...
    <>
      ...
      >
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
          ...
          <Heading level={1}
            className={`relative text-[clamp(1.3rem,6vw,3.2rem)] font-extrabold leading-[1.15] mb-4 md:mb-6 lg:mb-7 tracking-tight text-black dark:text-white ${poppins.className}`}
          >
            From Idea to{" "}
          ...
          {/* Buttons */}
          <div className="flex flex-col sm:flex-row md:flex-row lg:flex-row items-center justify-center gap-4 w-full sm:w-auto md:w-auto lg:w-auto mb-6">
            <Link href="/contact">
              <Button
                variant="primary"
                size="md"
        ...
        <div className="sm:flex md:flex lg:flex hidden flex-wrap justify-center items-center gap-4 mt-10 mb-2">
          {[
        ...
        <div
          className="hidden sm:hidden md:hidden lg:hidden gap-2 mt-10 mb-2 overflow-x-auto px-1"
