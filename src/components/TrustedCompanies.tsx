    ...
    <div className={`text-center ${className}`}>
      ...
      <div className="grid grid-cols-2 md:flex md:flex-wrap justify-center items-center gap-3 md:gap-4 lg:gap-6 max-w-4xl mx-auto mb-6 md:mb-8 px-4">
        {trustLogos.map((logo, idx) => (
          <div
            key={idx}
            className="group relative bg-gradient-to-br from-white/90 to-white/70 dark:from-blue-50/90 dark:via-slate-100/80 dark:to-indigo-50/90 backdrop-blur-sm border border-gray-200/60 dark:border-blue-200/40 rounded-lg px-3 py-2 md:px-4 md:py-3 hover:bg-white dark:hover:bg-gradient-to-br dark:hover:from-blue-50 dark:hover:via-slate-100 dark:hover:to-indigo-50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 min-w-[80px] md:min-w-[100px] flex items-center justify-center h-12 md:h-14"
          >
            <img
