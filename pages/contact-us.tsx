  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Contact Entalogics for custom software development, web apps, mobile apps, AI solutions, and Chromium browser development. Get a free quote today. We respond within 24 hours."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:url" content="https://entalogics.com/contact-us" />
        <meta property="og:title" content="Contact Us - Get Free Quote | Entalogics" />
        <meta property="og:description" content="Contact Entalogics for custom software development, web apps, mobile apps, AI solutions, and Chromium browser development. Get a free quote today." />
        <meta property="og:image" content="https://entalogics.com/logo.svg" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://entalogics.com/contact-us" />
        <meta property="twitter:title" content="Contact Us - Get Free Quote | Entalogics" />
        <meta property="twitter:description" content="Contact Entalogics for custom software development, web apps, mobile apps, AI solutions, and Chromium browser development. Get a free quote today." />
        <meta property="twitter:image" content="https://entalogics.com/logo.svg" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://entalogics.com/contact-us" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ContactPage",
              "name": "Contact Us - Entalogics",
              "description": "Contact Entalogics for custom software development services. Get a free quote for your project.",
              "url": "https://entalogics.com/contact-us",
              "mainEntity": {
                "@type": "Organization",
                "name": "Entalogics",
                ...
                "address": {
                  "@type": "PostalAddress",
                  "streetAddress": "2912 Meadowbrook Road",
                ...
                "sameAs": [
                  "https://m.facebook.com/EntaLogics/",
                  "https://x.com/EntaLogics",
                  "https://www.instagram.com/entalogics",
                  "https://www.linkedin.com/company/enta-logics"
                ]
              }
            })
          }}
                ...
                >
                  ...
                  <div className="text-center pt-1">
                    ...
                    <MotionP
                      ...
                      className="text-sm text-gray-600 dark:text-gray-300 mb-6 leading-relaxed px-1"
                    >
