...
const ServicePage: React.FC<ServicePageProps> = ({ service }) => {
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 xl:py-24">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-nowrap justify-center gap-1.5 sm:gap-2 pt-3 overflow-x-auto scrollbar-hide">
                  <div className="inline-flex items-center gap-1 sm:gap-1.5 bg-card dark:bg-gray-800 rounded-full border border-border dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 px-2 py-1 sm:px-3 sm:py-1.5 group whitespace-nowrap">
                    ...
                    <span className="text-[10px] sm:text-xs font-semibold text-gray-900 dark:text-white font-poppins">Expert Team</span>
                  </div>
                  ...
                  <div className="inline-flex items-center gap-1 sm:gap-1.5 bg-card dark:bg-gray-800 rounded-full border border-border dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 px-2 py-1 sm:px-3 sm:py-1.5 group whitespace-nowrap">
                    <div className="w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-br from-yellow-500/10 to-yellow-600/20 dark:from-yellow-500/20 dark:to-yellow-600/30 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                      <Zap className="w-2 h-2 sm:w-2.5 sm:h-2.5 text-yellow-600 dark:text-yellow-400" />
                    </div>
                    <span className="text-[10px] sm:text-xs font-semibold text-gray-900 dark:text-white font-poppins">Fast Delivery</span>
                  </div>
                  ...
                  <div className="inline-flex items-center gap-1 sm:gap-1.5 bg-card dark:bg-gray-800 rounded-full border border-border dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 px-2 py-1 sm:px-3 sm:py-1.5 group whitespace-nowrap">
                    ...
                    <span className="text-[10px] sm:text-xs font-semibold text-gray-900 dark:text-white font-poppins">Quality Code</span>
                  </div>
                </div>
              </div>
  ...
  {service.techStack && (
  <section className="pt-0 sm:pt-3 bg-transparent">
