        ...
        >
          ...
          <section className="relative isolate w-full bg-white dark:bg-[#0a1225] overflow-hidden">
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 lg:pt-16 xl:pt-24 pb-4 sm:pb-6 lg:pb-8">
              ...
              <div className="grid md:grid-cols-[1fr_auto] lg:grid-cols-[1fr_auto] gap-8 md:gap-10 lg:gap-12 items-start">
                {/* Left Content */}
                ...
                <div className="flex flex-row flex-wrap items-start justify-start gap-4 sm:gap-6 md:self-start md:ml-auto md:items-end md:justify-end lg:flex-col lg:items-center lg:justify-center lg:gap-8">
                  {/* Clutch Rating */}
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className="text-black dark:text-white font-poppins text-sm sm:text-base font-semibold">5.0</span>
                        <div className="flex gap-0.5">
                          {[...Array(5)].map((_, i) => (
                            <svg key={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#FFD700" className="w-3 h-3 sm:w-4 sm:h-4">
                              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                            </svg>
                          ))}
                        </div>
                      </div>
                      <p className="text-[10px] sm:text-xs font-normal text-gray-500 dark:text-gray-400 font-poppins">Based on 100+ Reviews</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col gap-1 sm:gap-2">
                      <div className="flex items-center gap-1 sm:gap-1.5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-3 h-3 sm:w-4 sm:h-4 text-pink-500">
                          <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                        </svg>
                        <span className="text-black dark:text-white font-poppins text-[10px] sm:text-xs">TOP RATED PLUS</span>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-1.5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-3 h-3 sm:w-4 sm:h-4 text-blue-500">
                          <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
                        </svg>
                        <span className="text-black dark:text-white font-poppins text-[10px] sm:text-xs">100% Job Success</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-5 md:gap-8">
                {[
                  ...
                  <div
                    key={index}
                    className="relative group flex items-center justify-center transition-all duration-300 hover:scale-110 w-24 sm:w-28 md:w-32"
                  >
                    {/* Award Badge SVG */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 214 221" fill="none" className="w-full h-auto text-yellow-400 dark:text-yellow-500 group-hover:text-yellow-500 dark:group-hover:text-yellow-400 transition-colors duration-300">
                      {/* Left Laurel */}
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center" style={{ top: '-8px' }}>
                      ...
                      {/* Award Title */}
                      <div className="text-[9px] sm:text-[11px] font-bold text-gray-800 dark:text-gray-200 leading-tight mb-1 max-w-[80px] sm:max-w-[110px]">
                        {badge.title.split('\n').map((line, i) => (
                          <div key={i}>{line}</div>
                        ))}
                      </div>
